...
/**
 * The app-wide AI provider configuration. There is a single provider/model
 * selection shared by summaries, meeting chat, and live Ask AI — this tab owns
 * it; summary-specific knobs (auto-summary, language) stay in the Summary tab.
 */
export function AIProviderSettings() {
  ...
  // Listen for model config updates from other components (chat pickers, etc.)
  useEffect(() => {
  ...
  return (
    <div className="bg-card rounded-lg border border-border p-6">
      ...
      <p className="text-sm text-muted-foreground mb-6">
        Configure the AI provider and model used across the app: meeting summaries, meeting chat, and live Ask AI.
      </p>
