          ...
          <div className="ml-4 flex items-center gap-2">
            ...
            {isMissing && (
              <button
                ...
                className="bg-primary text-primary-foreground px-3 py-1.5 rounded-md text-sm font-medium hover:bg-brand-hover transition-colors"
              >
                Download
              </button>
            )}
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-semibold text-brand font-mono tabular-nums">{Math.round(downloadProgress)}%</span>
              </div>
              <button
                onClick={(e) => {
                  e.stopPropagation();
