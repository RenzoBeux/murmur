  ...
  return <>
    ...
    {modals.modelSettings && (
      <div className="fixed inset-0 bg-overlay/50 flex items-center justify-center z-50 p-4">
        <div className="bg-card rounded-lg shadow-glass max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
          {/* Header */}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <select
                      className="px-3 py-2 text-sm bg-card border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring"
                    ...
                    <select
                      className="flex-1 px-3 py-2 text-sm bg-card border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring"
                  ...
                  <div>
                    ...
                    <div className="grid gap-4 max-h-[400px] overflow-y-auto pr-2">
                      {models.map((model) => (
                        <div
                          key={model.id}
                          className={`bg-card p-4 rounded-lg shadow cursor-pointer transition-colors ${modelConfig.model === model.name ? 'ring-2 ring-ring bg-brand/10' : 'hover:bg-accent'
                            }`}
          ...
          <div className="border-t p-6 flex justify-end">
            <button
              onClick={() => onClose('modelSettings')}
              className="px-4 py-2 text-sm font-medium text-primary-foreground bg-primary rounded-md hover:bg-brand-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring"
            >
              Done
            </button>
          </div>
    ...
    {modals.deviceSettings && (
      <div className="fixed inset-0 bg-overlay/50 flex items-center justify-center z-50">
        <div className="bg-card rounded-lg p-6 max-w-md w-full mx-4 shadow-glass max-h-[90vh] overflow-y-auto">
    ...
    {modals.modelSelector && (
      <div className="fixed inset-0 bg-overlay/50 flex items-center justify-center z-50">
        <div className="bg-card rounded-lg max-w-4xl w-full mx-4 shadow-glass max-h-[90vh] flex flex-col">
          {/* Fixed Header */}
          ...
          <div className="p-6 pt-4 border-t border-border flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-muted-foreground">Show Confidence Indicators</p>
            ...
            <button
              onClick={() => onClose('modelSelector')}
              className="px-4 py-2 text-sm font-medium text-foreground bg-secondary rounded-md hover:bg-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring"
            >
    ...
    {modals.errorAlert && (
      <div className="fixed inset-0 bg-overlay/50 flex items-center justify-center z-50">
        <Alert className="max-w-md mx-4 border-destructive/40 bg-card shadow-glass">
    ...
    {modals.chunkDropWarning && (
      <div className="fixed inset-0 bg-overlay/50 flex items-center justify-center z-50">
        <Alert className="max-w-lg mx-4 border-warning/40 bg-card shadow-glass">
