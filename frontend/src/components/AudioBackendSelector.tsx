    ...
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          ...
          {showTooltip && (
            <div className="absolute z-10 left-6 top-0 w-64 p-3 text-xs bg-elevated text-foreground border border-border rounded-lg shadow-glass">
          ...
          return (
            ...
            >
              <input
                ...
                disabled={isDisabled}
                className="mt-1 h-4 w-4 text-brand focus:ring-ring border-border"
              />
