    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <select
          ...
          className="w-full px-3 py-2 text-sm bg-card border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring disabled:bg-muted disabled:text-muted-foreground"
        >
        ...
        <div className="text-xs space-y-2 pt-2">
          ...
          {selectedLanguage === 'auto-translate' && (
            <div className="p-2 bg-brand/10 border border-brand/40 rounded text-brand">
