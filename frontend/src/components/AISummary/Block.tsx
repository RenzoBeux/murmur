  ...
  return (
    <div 
      className={`group relative min-h-[24px] flex items-start rounded transition-all duration-150 ease-in-out
        ${isSelected ? 'bg-brand/10 ring-1 ring-brand/30' : 'hover:bg-accent/50'}`}
    ...
    >
      ...
      <div className="relative flex-1 py-0.5 px-1">
        ...
        {showCommands && (
          <div 
            ref={commandsRef}
            className="absolute left-0 top-full mt-1 w-64 bg-elevated rounded-lg shadow-glass border border-border py-2 z-50
