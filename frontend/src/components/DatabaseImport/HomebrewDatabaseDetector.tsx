...
export function HomebrewDatabaseDetector({ onImportSuccess, onDecline }: HomebrewDatabaseDetectorProps) {
  ...
  return (
    <div className="mb-4 p-4 bg-brand/10 border-2 border-brand/40 rounded-lg">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="bg-background/50 rounded p-2 mb-3">
            ...
            <p className="text-xs text-brand font-mono tabular-nums mt-1">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={handleNo}
              disabled={isImporting}
              className="flex-1 px-4 py-2 border-2 border-brand/40 text-brand rounded-lg hover:bg-brand/10 disabled:bg-muted disabled:cursor-not-allowed transition-colors"
            >
              No, Browse Manually
            </button>
          </div>
