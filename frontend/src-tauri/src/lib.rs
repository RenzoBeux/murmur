...
// Global language preference storage. The UI pushes the saved preference here on startup;
// until it does, default to "auto" (detect and keep the original language) to match the
// frontend default. Defaulting to "auto-translate" meant anything transcribed before that
// sync landed came back translated into English.
...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Project commands
            api::projects_api::api_list_projects,
            api::projects_api::api_get_project,
            api::projects_api::api_create_project,
            api::projects_api::api_update_project,
            api::projects_api::api_delete_project,
